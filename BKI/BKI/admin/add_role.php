                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="Employee Activity">Employee Activity</span></a>
                        <ul class="menu-content">
                            ...
                            <libxml_set_streams_context><a class="d-flex align-items-center" href="planning.php"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Planning">Planning</span></a>
                            </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" name="nup" placeholder="Number ..." required />
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-1">
